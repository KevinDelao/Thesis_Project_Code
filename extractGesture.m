...
%change depending on which db being used
for subject=1:27
    subject;
    ...
    % Save latest sample array
     save([savePath '\s' num2str(subject) '_gestureLatest.mat gesture']);
    % eval(['save ' gesture '\s' num2str(subject) '_gestureLatest.mat gesture']);
    ...
    for ii=windowLength:numel(gesture) %
        ...
        % Get majority of movement in size of windowLength
